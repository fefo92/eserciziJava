...
public class Main {
    ...
    private static void exercise1() {
        ...
        String niceString = "Questa è una stringa molto bella";
        System.out.println(niceString.toUpperCase());
        System.out.println(niceString.toLowerCase());
    }
    ...
    private static void exercise2() {
        ...
        String middleName = "Fefo";
        String lastName = "Devoti";
