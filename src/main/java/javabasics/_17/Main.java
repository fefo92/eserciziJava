...
public class Main {
    ...
    private static void exercise1() {
        ...
        long totalBalanceEuro = myBankBalanceEuro + questionableFundsEuro;
        System.out.println(totalBalanceEuro);
    }
     ...
     *    2b: The age of a baby in months INT
...
//        System.out.println(localDate.getMonthValue());
        ...
        System.out.println("Today is " + localDate.getDayOfWeek() + " " + localDate.getDayOfMonth() + "th of "
                + localDate.getMonth() + " " + localDate.getYear());
        System.out.println("Is " + localDate.getDayOfYear() + "th day of the year and "
                + localDate.getMonthValue() + "nd month of the year " + localDate.getYear());
