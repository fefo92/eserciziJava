...
public class Main {
    ...
    private static void exercise3() {
        ...
        //Write your code here
        if (isTestRetry && ourTestScore >= 8){
            ourTestScore = 7;
        }

        if (ourTestScore >= 9 && ourTestScore < maxTestScore) {
            System.out.println("A");
        } else if (ourTestScore >= 8 && ourTestScore < maxTestScore) {
            System.out.println("B");
        } else if (ourTestScore >= 7 && ourTestScore < maxTestScore) {
            System.out.println("C");
        } else if (ourTestScore >= 6 && ourTestScore < maxTestScore) {
