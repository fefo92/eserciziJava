package javainproduction._2_javaStreams;
...
public class Exercises {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        // Your code here
        Set<Integer> dispari = ourNumbers.stream()
                .filter(n -> n % 2 != 0)
    ...
    private static void exercise3() {
        ...
        // Your code here
        Set<String> collect = alice.stream().map(String::toUpperCase).collect(Collectors.toSet());
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        //Your code here
        Set<Integer> set = ourNumbers.stream().filter(n -> n % 2 == 0).map(n -> n * 2).collect(Collectors.toSet());
