package javaadvanced._3_Collections;
...
//         toSet(list); //<-- uncomment
    ...
    private static void toSet(Set<String> list) {
     ...
     *    Answer: LIST perché prende l'ordine (index) in base a come li inseriamo quindi uno dopo l'altro
     *
     *    2 - You want to store the students in a class and their grades
     *    Answer: SET perché non mi interessa l'ordine, ma che non siano doppi gli studenti
     *
     *    3 - You want to store the countries in the world in order of age
     *    Answer: SET perché gli stati non possono essere doppi
     *
     *    4 - You want to store the products available for purchase in an online store, along with their corresponding prices.
     *    Answer: MAP perché devo avere una chiave e un valore anche per poi riuscire a richiamarli in caso di necessità
     *
